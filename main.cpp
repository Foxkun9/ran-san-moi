#include <stdio.h>
#include <windows.h>        //by Foxkun coder
#include <conio.h>
#include <time.h>
#include <stdlib.h>
#include <math.h>
...
void khungngoai()
{
    ...
    gotoxy(25,2); TextColor(12); printf("Foxkun");
    TextColor(4);
        for(int i = 0; i<55; i++)
    {
    ...
    gotoxy(27, 37); TextColor(4); printf("sus ");
    gotoxy(38, 37); TextColor(3); printf("amongus");
    gotoxy(79,41);
}
void playgame(int &thoat, char name[], int &lever, Snake &luusnake, char dname[])
{
    ...
    if(toado == 15) vaogame(name, lever, luusnake, dname);
    ...
    else if(toado == 19)
     {
         ...
         TextColor(9); gotoxy(51,17); printf("Fox_kun");
         Sleep(2000);
     }
}
...
void khungplay()
{
    ...
    gotoxy(38, 39); TextColor(3); printf("amongus moment");
}
void help(int &thoat, char name[], int &lever,  Snake &luusnake, char dname[])
{
    khungplay();
...
void about(int &thoat, char name[], int &lever, Snake &luusnake, char dname[])
{
 ...
 gotoxy(22, 6); TextColor(11); printf("Name:");       gotoxy(34, 6); TextColor(15); printf("Fox kun");
 gotoxy(22, 7); TextColor(11); printf("Birthday:");   gotoxy(34, 7); TextColor(10); printf("10/02/1009");
 gotoxy(22, 8); TextColor(11); printf("Fcebook:");    gotoxy(34, 8); TextColor(10); printf("Fb.com/duylam");
 gotoxy(22, 9); TextColor(11); printf("Gmail:");      gotoxy(34, 9); TextColor(10); printf("luuduylam29gmail.com");
 gotoxy(22, 10); TextColor(11); printf("Address:");   gotoxy(34, 10); TextColor(10); printf("vinh tuong-vinh phuc");
 gotoxy(22, 11); TextColor(11); printf("Schools:");   gotoxy(34,11); TextColor(10); printf("THCS thi tran yen minh");
                                                      gotoxy(42,12); TextColor(9); printf("(                )");
                                                      gotoxy(43,12); TextColor(10); printf("Class: 9C");
 gotoxy(22, 13); TextColor(11); printf("Occupation:"); gotoxy(34, 13); TextColor(10); printf("Hoc Sinh ");
